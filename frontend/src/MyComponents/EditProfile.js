        ...
        <div className="text-center container w-25 rounded bg-dark">
            <div className="form-signin my-5 p-3">
                <form onSubmit={saveChanges}>
                    ...
                    <div className="form-floating mt-4">
                        <input type="itemTitle" className="form-control" onChange={(e) => {setCity(e.target.value)}} value={location.state.locationUrl} placeholder="name@example.com" />
                        <label htmlFor="floatingInput">Provide City</label>
                    </div>
                    <div className="form-floating mt-4">
                        <input type="text" className="form-control" onChange={(e) => {setPhone(e.target.value)}} value={location.state.phone} placeholder="name@example.com" />
                        <label htmlFor="floatingInput">Phone Number</label>
                    </div>
                    <div className="form-floating mb-3 mt-4">
                        <input type='text' className="form-control" onChange={(e) => {setName(e.target.value)}} value={location.state.name} placeholder="Price" />
